...
**Where this fits:** this is the lightweight, bring-your-own-CSV CLI in my data-AI portfolio. For the heavyweight version of the same idea — a tool-calling agent with a sandboxed SQL layer, independent verification of every claimed number, and a ground-truth eval harness — see [querymind](https://github.com/ps-cmd777/querymind). For retrieval systems, see [postmark](https://github.com/ps-cmd777/postmark) and [gdpr-qa](https://github.com/ps-cmd777/gdpr-qa).
...
claude-data-reporter analyze data.csv --model claude-opus-4-8
```
